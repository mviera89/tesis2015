	...
	public void exportarModelo(DefaultDiagramModel modeloAdaptado, DefaultDiagramModel modelo, HashMap<String, String[]> puntosDeVariacion){
		try{
			...
			/*	String processBriefDescription = "";
				...
				List<Element> elementos = modelo.getElements(); //modeloAdaptado.getElements();
...
//						String diagramURI = s.getDiagramURI();
	...
	public String agregarProcesos(String contentCategoryPackageName, TipoContentCategory contentCategory, String contentCategoryId, String idProcessView,
			   						String contentCategoryOrderingGuide, String contentCategorySuppressed, String contentCategoryVariabilityType, String methodConfigurationId,
			   						Struct s, DefaultDiagramModel modelo, HashMap<String, String[]> puntosDeVariacion){
		String idCapPattern = "";
		TipoElemento tipo = s.getType();
		if (tipo != null){
			if (tipo == TipoElemento.DELIVERY_PROCESS){
